...
var usuarioModel_1 = __importDefault(require("../model/usuarioModel"));
...
var validateUser = function (res, req, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, usuarioModel_1["default"].getUsuario({ email: email, password: password })];
            case 1:
                result = _b.sent();
                return [4 /*yield*/, bcrypt_1["default"].compare(req.body.password, result.password)];
            case 2:
...
exports["default"] = { encryptPassword: encryptPassword, validateUser: validateUser, generateToken: generateToken };
